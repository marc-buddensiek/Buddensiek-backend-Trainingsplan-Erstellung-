...
| 7 | **Conditioning-Formate** 🟡 Naht 1–5 fertig (Schema-Enabler + Format-Baukasten + Naht 3 räumliche Format-Rotation + Naht 4 Pool-Selektor A1-deterministisch + **Naht 4d** Ladders/Format-Maxima/Multi-Format-Segmentierung + `conditioning_block_2` + **Naht 4e** Übungs-Rotation reiner C-Tage + Finisher-Format-/Übungs-Rotation {amrap,zirkel} + **Naht 5 Athletik** (skill-Dosierung, keine RPE, kein Cardio, Deload, Z2/Athletik-Rotation, L1-BW-Fallback); +33 Übungen). **Offen:** nur Komplexe (vordefinierte Coach-Ketten); Coach-Pool-Ausbau (inkl. Athletik L1/BW) | 3–4 | 4 |
