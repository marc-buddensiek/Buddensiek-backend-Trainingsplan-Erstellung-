...
| 7 | **Conditioning-Formate** 🟡 Naht 1–4d fertig (Schema-Enabler + Format-Baukasten + Naht 3 räumliche Format-Rotation + Naht 4 Pool-Selektor A1-deterministisch + **Naht 4d** Ladders block-dosierbar/Format-Maxima/Multi-Format-Segmentierung langer C-Tage mit kapazitätsbewusstem Erstformat + `conditioning_block_2`; +33 Übungen; For Time/EMOM/Mixed Intervals + Komplexe-Auto gestrichen). **Offen:** Naht 4e Übungs-/Finisher-Format-Rotation, Naht 5 Athletik, Komplexe (vordefinierte Coach-Ketten); Coach-Pool-Ausbau | 3–4 | 4 |
