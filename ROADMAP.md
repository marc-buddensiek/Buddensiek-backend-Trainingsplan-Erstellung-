...
| 7 | **Conditioning-Formate** 🟡 Naht 1–4 fertig (Schema-Enabler + Format-Baukasten + Naht 3 Format-Rotation räumlich + Naht 4 Pool-Selektor A1-deterministisch: Finisher + reine C-Tage ziehen equipment-korrekt aus dem Conditioning-Pool; +33 Conditioning/Athletik-Übungen; For Time/EMOM/Mixed Intervals gestrichen). **Offen:** Naht 4d Ladders/Komplexe dosierbar (Coach-Block-Dauern), Naht 4e Übungs-/Finisher-Format-Rotation, Naht 5 Athletik; Coach-Pool-Ausbau | 3–4 | 4 |
