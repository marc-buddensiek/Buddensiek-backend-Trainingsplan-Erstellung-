...
| 7 | **Conditioning-Formate** 🟡 Naht 1+2 fertig (Schema-Enabler + Format-Baukasten: 7 Formate, Block-Stapelung Tabata/Density, Conditioning ohne RPE, Dauer=session_dauer_min, Fettabbau gemischt+2C; For Time/EMOM/Mixed Intervals gestrichen). **Offen:** Naht 3 Rotation, Naht 4 Selektor-Umbau (+Ladders/Komplexe), Naht 5 Athletik + Recomp-Finisher-Ausbau + Coach-Übungen | 3–4 | 4 |
